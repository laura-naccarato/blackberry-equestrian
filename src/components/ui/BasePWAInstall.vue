<template>
  <Transition name="slide-down">
    <div
      ...
      class="fixed bottom-0 left-0 right-0 z-50 bg-navy text-white shadow-strong p-4 md:p-6"
      role="banner"
      ...
      <div class="container-wide">
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-4">
            <div class="w-12 h-12 bg-tan rounded-lg flex items-center justify-center flex-shrink-0">
              <svg class="w-6 h-6 text-burgundy" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div class="flex items-center space-x-3">
            <button
              @click="dismiss"
              class="text-gray hover:text-white transition-colors p-2 min-h-[44px] min-w-[44px] flex items-center justify-center"
