        ...
        <div class="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            <BaseCard variant="elevated">
              <h2 class="text-2xl font-serif text-deep-forest mb-6">Send Us a Message</h2>
              ...
              <form @submit.prevent="handleSubmit" class="space-y-4">
                ...
                <div class="flex items-center">
                  <input
                    ...
                    type="checkbox"
                    class="h-4 w-4 text-warm-gold focus:ring-warm-gold border-warm-gray rounded"
                  >
          ...
          <div class="space-y-6">
            ...
            <BaseCard variant="bordered">
              <h3 class="text-xl font-semibold text-deep-forest mb-4 flex items-center">
                <MapPinIcon class="h-6 w-6 mr-2 text-warm-gold" />
                Visit Our Facility
              </h3>
            ...
            <BaseCard variant="bordered">
              <h3 class="text-xl font-semibold text-deep-forest mb-4 flex items-center">
                <PhoneIcon class="h-6 w-6 mr-2 text-warm-gold" />
                Get in Touch
              </h3>
              <div class="space-y-3">
                <a
                  href="tel:905-555-0123"
                  class="flex items-center text-charcoal hover:text-warm-gold transition-colors"
                >
            ...
            <BaseCard variant="bordered">
              <h3 class="text-xl font-semibold text-deep-forest mb-4 flex items-center">
                <ClockIcon class="h-6 w-6 mr-2 text-warm-gold" />
                Hours of Operation
              </h3>
              <div class="space-y-2 text-charcoal">
                ...
                <div class="pt-3 mt-3 border-t border-warm-gray/20">
            ...
            <!-- Social Media -->
            <BaseCard variant="bordered">
              <h3 class="text-xl font-semibold text-deep-forest mb-4">Follow Us</h3>
              <div class="flex gap-4">
                <a
                  href="https://facebook.com/blackberryequestrian"
                  target="_blank"
                  class="p-3 bg-sage-green/20 rounded-lg hover:bg-sage-green/30 transition-colors"
                  aria-label="Facebook"
                >
                  <svg class="h-6 w-6 text-deep-forest" fill="currentColor" viewBox="0 0 24 24">
...
<style scoped>
.form-input {
  @apply block w-full px-4 py-3 border border-warm-gray/30 rounded-lg;
  @apply focus:outline-none focus:ring-2 focus:ring-warm-gold focus:border-transparent;
  @apply placeholder-warm-gray text-charcoal bg-white;
  @apply min-h-[44px];
}
